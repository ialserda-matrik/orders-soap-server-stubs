 ...
 * generated in the nl.matrik.ws.trainings package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetOrdersResponse_QNAME = new QName("http://trainings.ws.matrik.nl/", "getOrdersResponse");
    private final static QName _CreateOrdersResponse_QNAME = new QName("http://trainings.ws.matrik.nl/", "createOrdersResponse");
    private final static QName _DeleteOrdersResponse_QNAME = new QName("http://trainings.ws.matrik.nl/", "deleteOrdersResponse");
    private final static QName _GetOrdersRequest_QNAME = new QName("http://trainings.ws.matrik.nl/", "getOrdersRequest");
    private final static QName _CreateOrdersRequest_QNAME = new QName("http://trainings.ws.matrik.nl/", "createOrdersRequest");
    private final static QName _DeleteOrdersRequest_QNAME = new QName("http://trainings.ws.matrik.nl/", "deleteOrdersRequest");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: nl.matrik.ws.trainings
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://trainings.ws.matrik.nl/", name = "getOrdersResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://trainings.ws.matrik.nl/", name = "createOrdersResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://trainings.ws.matrik.nl/", name = "deleteOrdersResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://trainings.ws.matrik.nl/", name = "getOrdersRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://trainings.ws.matrik.nl/", name = "createOrdersRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://trainings.ws.matrik.nl/", name = "deleteOrdersRequest")
